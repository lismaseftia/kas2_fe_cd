        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="post" action="<?php echo base_url("login/cek"); ?>" class="needs-validation" novalidate="">
                  <div class="form-group">
                    <label for="nim">NIM</label>
                    <input id="nim" type="nim" class="form-control" name="NIM" tabindex="1" required autofocus>
